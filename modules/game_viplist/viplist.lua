...
function createEditWindow(widget)
	...
	local function cancelFunction()
		-- Detacha handlers e destrói grupos antes de destruir a janela
		if okButton then okButton.onClick = nil end
		if cancelButton then cancelButton.onClick = nil end
		if editVipWindow then
